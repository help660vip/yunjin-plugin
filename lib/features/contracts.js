...
export const FEATURE_CONTRACTS = Object.freeze({
  ...
  '08': { area: 'core', view: 'table', access: 'master', usage: '查看、校验、重载和修改全局/群/用户配置。', actions: ['查看', '获取', '设置', '重载', '校验'], args: ['作用域', '键', 'JSON 值'], dependencies: ['config', 'audit'] },
  ...
  '49': { area: 'community', view: 'table', access: 'admin', usage: '维护活动报名状态与去重参与者。', actions: ['开启', '关闭', '参加', '列表'], args: ['活动名'], dependencies: ['storage', 'policy'] },
